    ...
    <div class="py-16 shadow-lg shadow-indigo-500/40">
      <Head>
        ...
        <meta name="description"
                    content="This page is Sign Up  Page for site" />
                <meta name="keywords"
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            >
              ...
              <h1
                onClick={async () => {
                  await signIn("google", {
                 callbackUrl: "https://pcwebclient.vercel.app/",
                  });
                }}
            ...
            <div class="mt-4 flex items-center justify-between">
              ...
              <div class="text-xs cursor-pointer text-center text-gray-500 uppercase">
            ...
            <div class="mt-4 flex items-center justify-between">
              ...
              <Link href="/login" class="text-xs text-gray-500 uppercase">
                or Login
              </Link>
              <span class="border-b w-1/5 md:w-1/4"></span>
            </div>
